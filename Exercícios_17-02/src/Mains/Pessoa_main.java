...
public class Pessoa_main {
    public static void main(String[] args) {
        ...
        Empregado empregado = new Empregado("Luiz", "Rua do Luiz", "11 1111-1111", 1, 3000, 3);
        Administrador administrador = new Administrador("Luiza", "Rua da Luiza", "12 1111-2111", 1, 5000, 3, 300);
